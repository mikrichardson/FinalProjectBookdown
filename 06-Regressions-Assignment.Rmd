...
```{r, fig.cap = 'Figure 1. Time series of corn yield in Winneshiek County. It is demonstrated that there is a clear, positive trend of corn yield over time. Additionally, the linear model has a p-value <0.05, providing evidence of a significant time trend for corn yields.'}
win_corn <- cornyields %>%
...
```{r, fig.cap = 'Figure 2. Plot of corn yield versus time for Winneshiek County with a quadratic time trend line. Based on the model, the trend is linear and not curved meaning that there is no evidence for a slowing yield growth.'}
...
```{r, fig.cap = 'Figure 3. Plot of corn yield versus summer temperature in Winneshiek County with a quadratic trend model. Based on the model, there is negative relationship between temperature and corn yields with time. Looking at the quadratic versus linear model is helpful in identifying this trend.'}
...
```{r, fig.cap = 'Figure 4. Scatterplot of summer temperatures and corn yields in 2018 for all counties with a linear model. Based on the linear model summary, the p-value is >0.05, providing no evidence of a relationship between temperature and corn yields across all counties in 2018.'}
...
```{r, fig.cap = 'Figure 6. Time series for soybean yields in Buena Vista County. It is demonstrated that there is a clear, positive trend of soybean yield over time. Additionally, the linear model has a p-value <0.05, providing evidence of a significant time trend for soybean yields.'}
